...
2. **일일 실습 세션(1–3분 짧은 루틴)**
   ...
   - 단서/감정/충동/대체행동 기록(10초 이내로. Mitchell CBT의 Homework에 해당)
    	- 단서(Stimulus/Cue): “무엇이 촉발했나?”
			- 선택지를 제공하되, 사용자가 자유서술할 수 있게 한다. 챗봇은 자유서술로부터 사용자가 수정해야 하는 '자동사고'를 탐지한다.
		- 감정(Affect): “그때 감정/긴급도는?” (예시 답변: 불안, 지루함, 설렘, 스트레스)
		- 충동 강도: 슬라이더(0–10)로 선택
		- 충동(Urge): “무엇을 하고 싶었나?” (예시 답변: 장바구니 담기, 즉시 결제, 리뷰 탐색, 앱 둘러보기)
		- 대체행동(Alternative Behavior): “대신 뭘 했나/할 건가?” (예: 물 한 잔 마시기, 심호흡, 3분 동안 창 밖 보기)
